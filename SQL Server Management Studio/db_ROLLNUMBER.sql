...
FOREIGN KEY (OrderID) REFERENCES UserID(tblOrder);
ALTER TABLE tblProduct
...
as SELECT [ProductID], [ProductName],[Price] 
FROM [tblProduct]
...
AS
BEGIN
SELECT SUM(Quantity), OrderID, ProductID, Quantity, UnitPrice FROM tblOrderDetail
	END
