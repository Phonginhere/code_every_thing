...
--explict transcription
begin tran 
INSERT INTO tblCustomer VALUES ('cust01', 'Nguyễn Thanh', '0', 'Hà Nội', '0166123456')
commit
...
begin tran
--pay
INSERT INTO tblSales VALUES ('cust01', 'stock01', '2020/04/08 10:34:09 AM', 11)
--generate bill
INSERT INTO tblSales VALUES ('cust02', 'stock02', '2020/04/06 12:50:12 PM', 11)
rollback
--notify
INSERT INTO tblSales VALUES ('cust03', 'stock03', '2020/04/04 6:03:55 PM', 11)
commit


SELECT * FROM tblSales
--autocommit transcription 
...
drop constraint FK__tblSales__custID__3E723F9C
...
begin catch 
	print 'cannot divide by 0'
	RAISERROR ('cannot divide by 0', 15, 11)
end catch
